...
$querya = "SELECT
    ...
    {
        echo  '<meta http-equiv="Refresh" content="0.5;url=adminConPrograma.php">';
        die();
    }
...
if (isset($_POST['submit']) && $_POST['submit'] == 'submit') {
  ...
  echo '<script language="javascript">alert("Deporte registrado exitosamente.");</script>';
          ...
          echo  '<meta http-equiv="Refresh" content="0.5;url=conRegMon.php">';
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <td>
                        ...
                        <form action="recDepMon.php" method="post">
