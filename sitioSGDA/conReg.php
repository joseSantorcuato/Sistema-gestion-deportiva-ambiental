...
<body>
  ...
  $query = "select idRegistro, Fecha, Deporte, NombreCentroDeportivo, Icap, Localidad_idLocalidad, Usuario_idUsuario from Registro  ORDER BY idRegistro DESC LIMIT 10";
  ...
  ?>
    <div class="row">
        <div class="col-md-10 col-md-offset-1 tabla-rec">
            <form action="conRegPost.php" method="post">
